...
public class VendaDAO extends GenericDAO<Venda, String> implements IVendaDAO {
    ...
    private void buscarAssociacaoVendaProdutos(Connection connection, Venda venda)
        ...
        try {
            ...
            sbProd.append("P.ID AS ID_PRODUTO, P.CODIGO, P.NOME, P.DESCRICAO, P.VALOR, P.DEPARTAMENTO ");
    ...
    private StringBuilder sqlBaseSelect() {
        ...
        sb.append("C.ID AS ID_CLIENTE, C.NOME, C.SOBRENOME, C.CPF, C.TEL, C.ENDERECO, C.NUMERO, C.CIDADE, C.ESTADO ");
